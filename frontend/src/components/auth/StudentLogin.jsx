...
function StudentLogin() {
    ...
    return (
        <div className="panel-container" style={{ maxWidth: '400px', margin: '40px auto', padding: '32px' }}>
            <h2 style={{ textAlign: 'center', marginBottom: '24px', fontSize: '24px', fontWeight: 'bold' }}>Student Login</h2>
